  ...
  return (
    ...
    > 
      ...
      <div className="flex w-full justify-between pt-4">
        ...
        <Button color={tailwindColors.green[600]} onClick={() => {preFlightChecklistItems.push({ "name": "test", "value": [] }); setPreFlightChecklistItems(preFlightChecklistItems)}}>Add a new Checklist</Button>
      </div>
    </Modal>
  )
}