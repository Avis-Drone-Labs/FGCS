...
export const PLANE_MISSION_ITEM_COMMANDS_LIST = {
  ...
  MAV_CMD_DO_REPEAT_SERVO: 184,
  MAV_CMD_DO_REPEAT_RELAY: 182,
  MAV_CMD_DO_DIGICAM_CONFIGURE: 202, // (Camera enabled only)
  MAV_CMD_DO_DIGICAM_CONTROL: 203, // (Camera enabled only)
  MAV_CMD_DO_SET_CAM_TRIGG_DIST: 206, // (Camera enabled only)
  MAV_CMD_DO_SET_ROI: 201, // (Gimbal/mount enabled only)
  MAV_CMD_DO_GIMBAL_MANAGER_PITCHYAW: 10000, // (Gimbal/mount enabled only)
  MAV_CMD_DO_JUMP: 177,
  MAV_CMD_JUMP_TAG: 600,
  MAV_CMD_DO_JUMP_TAG: 601,
  MAV_CMD_DO_MOUNT_CONTROL: 205,
...
export const COPTER_MISSION_ITEM_COMMANDS_LIST = {
  ...
  MAV_CMD_NAV_GUIDED_ENABLE: 92, // (NAV_GUIDED only)
  MAV_CMD_NAV_DELAY: 93,
  MAV_CMD_NAV_PAYLOAD_PLACE: 94,
  MAV_CMD_DO_JUMP: 177,
  MAV_CMD_JUMP_TAG: 600,
  ...
  MAV_CMD_DO_MOUNT_CONTROL: 205, //(Gimbal/mount enabled only)
  MAV_CMD_DO_GIMBAL_MANAGER_PITCHYAW: 10000, //(Gimbal/mount enabled only)
  MAV_CMD_DO_PARACHUTE: 208, //(Parachute enabled only)
  MAV_CMD_DO_GRIPPER: 211,
  MAV_CMD_DO_GUIDED_LIMITS: 222, //(NAV_GUIDED only)
  MAV_CMD_DO_SET_RESUME_REPEAT_DIST: 215,
  MAV_CMD_DO_FENCE_ENABLE: 207,
  MAV_CMD_DO_WINCH: 42600,
  MAV_CMD_STORAGE_FORMAT: 526,
...
export const MAV_FRAME_LIST = {
  ...
  MAV_FRAME_LOCAL_FRD: 21,
  MAV_FRAME_LOCAL_FLU: 22,
