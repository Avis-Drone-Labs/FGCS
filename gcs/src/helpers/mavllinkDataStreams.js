export const mavlinkMsgParams = {
  ...
  BATTERY_STATUS: {
    ...
    current_consumed: "Current consumed (mAh)",
    energy_consumed: "Energy consumed (hJ)",
    id: "Battery ID",
  ...
  HWSTATUS: { I2Cerr: "I2C error count", Vcc: "Board voltage (mV)" },
  LOCAL_POSITION_NED: {
    time_boot_ms: "Timestamp (ms)",
    vx: "X Speed (m/s)",
    vy: "Y Speed (m/s)",
  ...
  RANGEFINDER: { distance: "Distance (m)", voltage: "Raw voltage (V)" },
  SIM_STATE: {
    alt: "Altitude (m)",
    lat: "Latitude (°)",
    lat_int: "Latitude (°E7)",
