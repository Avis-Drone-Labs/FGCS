...
import { useSessionStorage, usePrevious, useLocalStorage, } from "@mantine/hooks"
      ...
      <div className="flex flex-col h-screen overflow-hidden">
        <div className="flex flex-1 overflow-hidden">
            ...
            <ResizableBox
                ...
                resizeHandles={['e']}
                axis="x"
                handle={<div className="w-2 h-full bg-falcongrey-900 hover:bg-falconred-500 cursor-col-resize absolute right-0 top-0 z-10"></div>}
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <ResizableBox
            ...
            resizeHandles={['n']}
            axis="y"
            handle={<div className="w-full h-2 bg-falcongrey-900 hover:bg-falconred-500 cursor-row-resize absolute top-0 left-0 z-10"></div>}
            className="relative bg-falcongrey-800 overflow-y-auto"
          >
