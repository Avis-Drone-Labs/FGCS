...
store.subscribe(() => {
    ...
    window.localStorage.setItem('wirelessConnection', store_mut.droneConnection.wireless)
    window.localStorage.setItem('baudrate', store_mut.droneConnection.baudrate)
    window.localStorage.setItem('connectionType', store_mut.droneConnection.connectionType)
    window.localStorage.setItem('networkType', store_mut.droneConnection.networkType)
